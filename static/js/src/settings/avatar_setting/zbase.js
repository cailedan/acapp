class AvatarSettings {
    ...
    save_avatar() {
        ...
        let outer = this;
        console.log("Access token:", this.menu.root.access);

        $.ajax({
            url: "https://app7342.acapp.acwing.com.cn/settings/avatar/", // 确保 URL 正确
            type: "post",
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: (resp) => {
                ...
                if (resp.result === "success") {
                    outer.menu.root.settings.photo = resp.photo;
